...
- Scanner plugins live under `poed.scanners`; reusable domain logic belongs in focused modules such as `ocr_worker`, `expedition_text`, `have_scan`, `unique_grid_geometry`, `uniquescan`, and `runeshape`.
